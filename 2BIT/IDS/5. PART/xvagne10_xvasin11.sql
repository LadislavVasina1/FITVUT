...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                                4. Projekt - Vytvoreni triggeru a procedur                                 --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                                                Triggery                                                   --
...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                                2. Projekt - Vlozeni hodnot do tabulek                                     --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                               3. Projekt - Vybrani urcitych dat (Selecty)                                 --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                              4. Projekt - Index pro optimalizovani dotazu                                 --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
select username, SUM(cena_celkem) suma from uzivatele
join objednavky o on uzivatele.id_uzivatele = o.id_uzivatele
...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                                       4. Projekt - Explain plans                                          --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
-- Prvni prubeh zobrazovani poctu produktu v danych kategoriich, bez indexu.
explain plan for
select nazev_kategorie, COUNT(id_produktu) pocet_produtku_v_kategorii from produkty
join kategorie k on id_kategorie = kategorie_id
group by nazev_kategorie;
...
-- Druhy porovnavaci beh, s indexy.
explain plan for
select nazev_kategorie, COUNT(id_produktu) pocet_produtku_v_kategorii from produkty
join kategorie k ON id_kategorie = kategorie_id
group by nazev_kategorie;
...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                                 4. Projekt - Prava pro druheho kolegu                                     --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
...
grant execute on druh_dopravy to XVASIN11;
grant execute on drazsi_nez to XVASIN11;
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                4. Projekt - Meterializovane view z tabulky jineho clena tymu a ukazka                     --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
...
insert into produkty (nazev_produktu, cena_produktu, popis_produktu, pocet_skladem, pocet_prodanych_kusu, kategorie_id)
values ('Samsung Z Fold 3', 49990.00, 'Skladacka', 42, 9, 5);
/
commit;
...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                                   4. Projekt - Demonstrace procedur                                       --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
begin
    druh_dopravy();
...
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
--                                   4. Projekt - Demonstrace triggeru                                       --
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
-- Trigger pro kontrolu poctu objednych produktu, pocet musi byt mensi nez na skalde.
-- 1) Dostatek skladem.
insert into objednavky_ma_produkty(objednavky_id_objednavky, produkty_id_produktu, qty, cena_pri_objednani)
values (1, 3, 5, 50000.00);
-- 2) Nedostatek.
insert into objednavky_ma_produkty(objednavky_id_objednavky, produkty_id_produktu, qty, cena_pri_objednani)
values (2, 3, 12, 50000.00);

-- Trigger pro kontrolu data objednavky, datum nesmi byt v budoucnosti (tedy ne vetsi nez akutalni datum).
-- Datum v minulosti.
insert into objednavky(id_uzivatele, id_vyrizujiciho, cena_celkem, datum_objednavky, datum_odeslani, druh_dopravy, zaplacena)
...
-- Datum v budoucnosti.
insert into objednavky(id_uzivatele, id_vyrizujiciho, cena_celkem, datum_objednavky, datum_odeslani, druh_dopravy, zaplacena)
values (1, 2, 34441.00, TO_DATE('2042/03/22 7:00:00', 'yyyy/mm/dd hh:mi:ss'), TO_DATE('2042/03/22 12:00:00', 'yyyy/mm/dd hh:mi:ss'), 'blazing_fast', 1);
